      ...
      @foreach ($comics as $comic)
        <tr>
            ...
            <td>
              ...
              <button type="button" class="btn btn-danger text-white btnToggle" data-toggle="modal" data-target="#exampleModal" data-id="{{$comic->id}}">
                Elimina
              </button>
            </td>
        </tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <form class="my_form" action="{{route("comics.destroy",$comic->id)}}" method="POST" class="d-inline-block">
                @csrf
                @method('DELETE')
                <button type="button" class="my_button btn btn-danger text-white">
                  Elimina
                </button>
              </form>
            </div>
